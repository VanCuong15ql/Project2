                    ...
                    <div className="mt-2" >
                        ...
                        <div className="mt-3 relative">
                            <label htmlFor="password" className="absolute px-1 font-semibold bg-[var(--login-form-container)]
                             left-3 z-20 text-blue text-xs  " > Password </label>
                            <Tippy
                                hideOnClick="false"
                                placement="left"
                                trigger="focus"
                        ...
                        <div className="mt-[70px] relative">
                            <label htmlFor="cfPassword" className="absolute px-1 font-semibold bg-[var(--login-form-container)] left-3 z-20 text-blue text-xs" > Confirm Password </label>
                            <Tippy
                                hideOnClick="false"
                                placement="left"
                                trigger="focus"
                        ...
                        <div className="mt-[140px] flex justify-end mr-5">
                            ...
                            <button
                                ...
                                className=" w-20 h-10 bg-blue text-white font-semibold rounded-md 
                                        hover:bg-blue duration-300 flex justify-center items-center
                    ...
                    <div className="border-t-2 pt-4 mt-4 px-3 flex items-center">
                        ...
                        <Link to="/login">
                            <button
                                ...
                                ${success ? "bg-blue hover:bg-blue" : "bg-gray-500 hover:bg-gray-600"}`}>
                                Login
                            </button>
                        </Link>
